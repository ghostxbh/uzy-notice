layui.define(['element', 'layer', 'form'], function (exports) {
    ...
    form.on('submit(login)', function (data) {
        ...
        setTimeout(function () {
        	 $.ajax({
            	...
            	type:'post',
            	dateType:'json',
            	data:{'time':(new Date()).toString(),"username":data.field.username,"password":data.field.password},
          		success:function(result){
		            ...
		            if (!result.success) {
		                ...
		                layer.closeAll('page');
		                setTimeout(function () {
		                    location.href = "/notice/main.html";
		                }, 1000);
		            }
          		}
             });
    ...
    function login() {
        $.get("/notice/login.html", function(result){
        	 layer.open({
                 id: 'layer-login',
                 type: 1,
                 title: false,
